...
- Release assets must include both the versioned Universal DMG `kurotty-$VERSION-macos-universal.dmg` and the stable direct-download alias `kurotty-macos-universal.dmg`, plus `SHA256SUMS`.
