...
final class TerminalScrollbackDiagnosticsTests: XCTestCase {
    ...
    func testSummaryReportsNormalScrollbackWithoutRowContent() {
        ...
        XCTAssertEqual(summary.firstRetainedRowIndex, 0)
        XCTAssertEqual(summary.lastRetainedRowIndex, 1)
        XCTAssertEqual(summary.nextRowIndex, 2)
        XCTAssertEqual(summary.droppedRowCount, 0)
    ...
    func testSummaryReportsOverflowAndDroppedRows() {
        ...
        XCTAssertEqual(summary.firstRetainedRowIndex, 20)
        XCTAssertEqual(summary.lastRetainedRowIndex, 29)
        XCTAssertEqual(summary.nextRowIndex, 30)
