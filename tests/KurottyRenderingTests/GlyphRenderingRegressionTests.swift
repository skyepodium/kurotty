...
final class GlyphRenderingRegressionTests: XCTestCase {
    ...
    func testTerminalNotificationsOnlyUseExplicitTerminalNotificationProtocols() throws {
        ...
        XCTAssertTrue(surfaceSource.contains("notifier.notifyBackgroundTaskCompleted(content: content)"))
        ...
        XCTAssertTrue(notifierSource.contains("func notifyBackgroundTaskCompleted(content: TerminalBackgroundTaskNotificationContent)"))
    ...
    func testCoreBridgeDoesNotUseCurrentDirectoryFallbacksInAppBundleMode() throws {
        ...
        XCTAssertTrue(source.contains("final class CoreBridge: TerminalCore, TerminalCoreCompatibilityDiagnosing, @unchecked Sendable"))
